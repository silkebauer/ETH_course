...
link-citations: yes
description: "This is a handout for the ETH migration course at Col de Bretolet. The output format for this example is bookdown::gitbook."
output:
  bookdown::gitbook:
    config:
      toc:
...
- install package afpt (Pennycuick flight energetics)
