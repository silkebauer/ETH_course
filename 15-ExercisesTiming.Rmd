...
If you prefer fitting a non-linear trend, use the R-code provided in the next R-chunk. What conclusion changes from the ones above (linear regression)? What additional information do you gain? 
...
## Additional data and literature on first arrival dates
...
@koh_extreme-value_2025 analyse first arrival dates based on citizen science data using state of the art statistical methods.  
...
The two studies showed that over the past 20 years, the Snowfinch did not advance the timing of the breeding enough to compensate the warming: @Schano.2021, @niffenegger_rising_2025. 
