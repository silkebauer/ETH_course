...
Look at Chapter \@ref(Sec:MigModels) again for background on state-dependent migration models and read at least three of the following papers: 
[@Bauer2018], 
...
1. Run the model using the standard parameter setting.
2. Change one parameter at a time and observe which output measures change
3. Develop an ecological question that you would like to tackle
4. Come up with a plan of how to test your own question(s)
  + which parameters would you need to change, 
  + change parameters by how much, 
  + which output measures would you look at, etc.
  
5. Run the respective scenarios
