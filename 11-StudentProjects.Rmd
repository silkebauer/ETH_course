...
The project is done in groups of 2-4 students. The product of the project will be an oral presentation (10 min) at Friday. The presentation includes an introduction of the study question, methods, results and discussion. The presentation can be shared among the students or it it can be held by one delegate. 


## Reading a paper

The projects include reading a few  papers. Therefore, we here give some tips in how to read papers.
