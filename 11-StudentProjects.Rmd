...
Phenology characterises the temporal course of migration. Naturally, phenology has different aspects, e.g. how individuals of a species migrate in a particular season (spread-out over season or almost synchronized), whether there are differences between the seasons, whether there differences or similarities in the timing of migration between species (some migrate late, some early), whether the timing of migration changes over the years, etc.

Potential research questions that you may select, include:
- Within a species: characterise phenology of migration in a single season

- Between species comparison: Characterise a selection of species in their migration phenology. 


Once you have one or more of the above, try to link the timing of migration to ecological variables,  
